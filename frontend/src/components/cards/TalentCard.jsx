  ...
  return (
    ...
    >
      <img
        ...
        className="h-[380px] w-full object-cover grayscale contrast-110 transition duration-700 group-hover:scale-[1.03] sm:h-[430px] lg:h-[460px]"
      />
      ...
      <div className="absolute inset-x-0 bottom-0 p-4 text-white sm:p-5">
        <p className="text-[0.62rem] uppercase tracking-editorial text-white/80">{talent.category}</p>
        <h3 className="mt-1 font-display text-2xl leading-none sm:text-3xl">{talent.stage_name}</h3>
        <p className="mt-2 text-[0.62rem] uppercase tracking-editorial text-white/80 sm:text-xs">{talent.city}</p>

        <div className="mt-4 grid grid-cols-2 gap-2 opacity-100 transition duration-500 md:mt-5 md:opacity-0 md:group-hover:opacity-100">
          <Link
